window.onload = function () {
    ...
    signInDialog.addEventListener('click', function (event) {
		let rect = signInDialog.getBoundingClientRect();
    ...
    function openRootDirectory() {
        ...
        mainWindowBody.innerHTML = `
            <div id="buttonDiskC" class="menu-item icon-and-text-container">
                ...
                <div id="buttonDiskE" class="menu-item icon-and-text-container unaccessible">
            ...
            openDirectory("\\\\server\\remote-pc\\golem\\filesystem\\C:\\Other\\", `
                ...
                <div class="menu-item icon-and-text-container">
                    ...
                    <div class="inlined-container">
                        ...
                        <div class="label">
                            <div>
                                Uploaded 29.10.2024 by <span>DOBROBOG</span>
                            </div>
                        </div>
                    </div>
                </div>
